...
if(isset($_POST['search'])){
    ...
    $searchquery="SELECT * FROM employee WHERE CONCAT(employee_number,emp_email,first_name,other_name,account_status,idnumber,phone,gender,department,emp_role,marital_status) LIKE '%$keyword%' and emp_role='HOD'";
...
$searchquery="select * from employee where emp_role='HOD' ";
$search_result=mysqli_query($con, $searchquery);
$countnum=mysqli_num_rows($search_result);
}
...
<head>
      <!--system title displayed on the window tab -->
    <title>LMS & PROGRESS TRACKING|Hod employee</title>
    <!--style-->
    <style>
          /** body style**/
          *{
    ...
    <div class="main">
        ...
        <div class="content">
                ...
                <div style="margin-bottom:30px; margin-top:100px; padding:20px;">
                    <h2 style="float:left; color:black;">Head of Departments List</h2>
