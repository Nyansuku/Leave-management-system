...
if(isset($_POST['search'])){
    ...
    $searchquery="SELECT * FROM leavetbl WHERE CONCAT(leavetype,emp_dept,leavestatus,employee_number,leave_start,leave_end,leavestatus) LIKE '%$keyword%' and leavestatus='disapproved'";
...
$searchquery="select * from leavetbl where leavestatus='disapproved'";
$search_result=mysqli_query($con, $searchquery);
$countnum=mysqli_num_rows($search_result);
...
<head>
      <!--system title displayed on the window tab -->
    <title>LMS & PROGRESS TRACKING|Disapproved leaves</title>
    <!--style link-->
    ...
    <div class="main">
        ...
        <div style="margin-top:100px;"></div>
                ...
                <div style="margin-bottom:30px; padding:20px;">
                    <h2 style="float:left; color:black;">Disapproved Leaves</h2>
